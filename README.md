...
Part A covers the core setup (tenant, app registration, self-service
sign-up user flow, MFA) that checklist assumes; Part B covers the
optional next step — blocking sign-up outright for emails that were
never invited.
